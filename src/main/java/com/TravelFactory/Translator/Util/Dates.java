package com.TravelFactory.Translator.Util;
...
public class Dates {
    ...
    public static Date atUtc(LocalDateTime date, TimeZone zone) {
        ...
        calendar.set(date.getYear(), date.getMonthOfYear() - 1, date.getDayOfMonth());//convert from locateDateTime to Calendar time
